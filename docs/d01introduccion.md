...
Una ves ejecutado la terminal (`cmd`), uno puede ir dirigiéndose a directorios o aplicaciones o archivos y 
ejecutar desde ella como se puede apreciar en la siguiente figura.

![windows](./img/fig01_cmd.png)
Figura 1.1.

Entonces, como indicamos que podemos ejecutar aplicación, en nuestro caso ejecutaremos Etabs, y por su 
puesto ponemos las instrucciones para ejecutar Python y Visual Studio Code.
...
aplicaciones, ¿de que modo afecta en nuestro estudio y propósito?, pues la respuesta es que, justamente 
vamos a necesitar este concepto, para poder ejecutar Etabs y/o poder conectarnos con Python, 
y poder manipular las funciones de modelado.
